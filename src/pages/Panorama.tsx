    ...
    hotSpots: [
      {
        ...
        handleClick: () => setOrganPopupVisible(true),
      },
      {
        pitch: 40,
        yaw: 240,
        type: "custom",
        cssClass: "organHotspot",
        handleClick: () => setMersonPopupVisible(true),
      },
      {
        pitch: 35,
        yaw: 320,
        ...
        handleClick: () => setSmallPulpitPopupVisible(true),
      },
      {
        pitch: 0,
        yaw: 200,
        ...
        handleClick: () => setRoodScreenPopupVisible(true),
      },
      {
        pitch: 25,
        yaw: 70,
        ...
        handleClick: () => setWarMemWindowPopupVisible(true),
      },
      {
        pitch: -10,
        yaw: 300,
        ...
        handleClick: () => setWarMemorialPopupVisible(true),
      },
      {
        pitch: 0,
        yaw: 0,
        ...
        handleClick: () => setAnteChapelPopupVisible(true),
      },
      {
        pitch: 30,
        yaw: 0,
        ...
        handleClick: () => setWestWindowPopupVisible(true),
      },
      {
        pitch: 0,
        yaw: 182,
        ...
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            <div className="popup-buttons">
              ...
              <button onClick={() => speakText('anteChapelParagraph')}>Listen To Audio</button>
        ...
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            <div className="popup-buttons">
              ...
              <button onClick={() => speakText('roodScreenParagraph')}>Listen To Audio</button>
              <button onClick={stopSpeech}>Stop Audio</button>
            </div>
            <div className="popup-close-button">
              <button className="close-button" onClick={() => {
      ...
      {warMemorialPopupVisible && (
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            <div className="popup-buttons">
              <button onClick={() => speakText('warMemParagraph')}>Listen To Audio</button>
              <button onClick={stopSpeech}>Stop Audio</button>
            </div>
            <div className="popup-close-button">
              <button className="close-button" onClick={() => {
      ...
      {mersonPopupVisible && (
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            <div className="popup-buttons">
              <button onClick={() => speakText('mersonParagraph')}>Listen To Audio</button>
              <button onClick={stopSpeech}>Stop Audio</button>
            </div>
            <div className="popup-close-button">
              <button className="close-button" onClick={() => {
      ...
      {smallPulpitPopupVisible && (
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            <div className="popup-buttons">
              <button onClick={() => speakText('smallPulpitParagraph')}>Listen To Audio</button>
              <button onClick={stopSpeech}>Stop Audio</button>
            </div>
            <div className="popup-close-button">
              <button className="close-button" onClick={() => {
        ...
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            <div className="popup-buttons">
              ...
              <button onClick={() => speakText('westWindowParagraph')}>Listen To Audio</button>
              <button onClick={stopSpeech}>Stop Audio</button>
            </div>
            <div className="popup-close-button">
              <button className="close-button" onClick={() => {
        ...
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            <div className="popup-buttons">
              ...
              <button onClick={() => speakText('organParagraph')}>Listen To Audio</button>
              <button onClick={stopSpeech}>Stop Audio</button>
            </div>
            <div className="popup-close-button">
              <button className="close-button" onClick={() => {
