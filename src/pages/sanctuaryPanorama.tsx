...
export const SanctuaryPanorama: React.FC = () => {
    ...
    hotSpots: [
      {
        ...
        handleClick: () => setDirectionPopupVisible(true),
      },
      {
        pitch: 35,
        yaw: 300,
        ...
        handleClick: () => setLargePulpitPopupVisible(true),
      },
      {
        pitch: 15,
        yaw: 315,
        type: "custom",
        cssClass: "largePulpitHotspot",
        handleClick: () => setRSmithPopupVisible(true),
      },
      {
        pitch: 13,
        yaw: 336,
        type: "custom",
        cssClass: "largePulpitHotspot",
        handleClick: () => setNorthEastPopupVisible(true),
      },
      {
        pitch: 20,
        yaw: 357,
        type: "custom",
        cssClass: "largePulpitHotspot",
        handleClick: () => setHarrowerPopupVisible(true),
      },
      {
        pitch: 15,
        yaw: 20,
        type: "custom",
        cssClass: "largePulpitHotspot",
        handleClick: () => setSouthEastPopupVisible(true),
      },
      {
        pitch: 15,
        yaw: 47,
        type: "custom",
        cssClass: "largePulpitHotspot",
        handleClick: () => setGeddesPopupVisible(true),
      },
      {
        pitch: 25,
        yaw: 255,
        type: "custom",
        cssClass: "largePulpitHotspot",
        handleClick: () => setCampbellPopupVisible(true),
      },
      {
        pitch: 0,
        yaw: 0,
        ...
        handleClick: () => setDeskPopupVisible(true),
      },
      {
        pitch: -30,
        yaw: 350,
        ...
        handleClick: () => setElphinstoneGravePopupVisible(true),
      },
      {
        pitch: 45,
        yaw: 0,
        ...
        handleClick: () => setChapelCeilingPopupVisible(true),
      },
      {
        pitch: 35,
        yaw: 90,
        ...
        handleClick: () => setExitPopupVisible(true),
      },
    ]
  };
        ...
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            <div className="popup-buttons">
              <button onClick={() => speakText('pulpitParagraph')}>Listen To Audio</button>
      ...
      {elphinstoneGravePopupVisible && (
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            <div className="popup-buttons">
              <button onClick={() => speakText('graveParagraph')}>Listen To Audio</button>
              <button onClick={stopSpeech}>Stop Audio</button>
            </div>
            <div className="popup-button-close">
              <button className="close-button" onClick={() => {
        ...
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            <div className="popup-buttons">
              ...
              <button onClick={() => speakText('harrowerParagraph')}>Listen To Audio</button>
              <button onClick={stopSpeech}>Stop Audio</button>
            </div>
            <div className="popup-button-close">
              <button className="close-button" onClick={() => {
      ...
      {campbellPopupVisible && (
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            <div className="popup-buttons">
              <button onClick={() => speakText('campbellParagraph')}>Listen To Audio</button>
              <button onClick={stopSpeech}>Stop Audio</button>
            </div>
            <div className="popup-button-close">
              <button className="close-button" onClick={() => {
        ...
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            <div className="popup-buttons">
              ...
              <button onClick={() => speakText('northEastParagraph')}>Listen To Audio</button>
              <button onClick={stopSpeech}>Stop Audio</button>
            </div>
            <div className="popup-button-close">
              <button className="close-button" onClick={() => {
      ...
      {southEastPopupVisible && (
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            ​</p>
            <div className="popup-buttons">
              <button onClick={() => speakText('southEastParagraph')}>Listen To Audio</button>
              <button onClick={stopSpeech}>Stop Audio</button>
            </div>
            <div className="popup-button-close">
              <button className="close-button" onClick={() => {
        ...
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            <div className="popup-buttons" ref={popupRef}>
              <button onClick={() => speakText('geddesParagraph')}>Listen To Audio</button>
              <button onClick={stopSpeech}>Stop Audio</button>
            </div>
            <div className="popup-button-close">
              <button className="close-button" onClick={() => {
      ...
      {rsmithPopupVisible && (
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            ​</p>
            <div className="popup-buttons">
              <button onClick={() => speakText('rsmithParagraph')}>Listen To Audio</button>
              <button onClick={stopSpeech}>Stop Audio</button>
            </div>
            <div className="popup-button-close">
              <button className="close-button" onClick={() => {
      ...
      {chapelCeilingPopupVisible && (
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            <div className="popup-buttons">
              <button onClick={() => speakText('ceilingParagraph')}>Listen To Audio</button>
              <button onClick={stopSpeech}>Stop Audio</button>
            </div>
            <div className="popup-button-close">
              <button className="close-button" onClick={() => {
      ...
      {deskPopupVisible && (
        <div className="popup">
          <div className="popup-content" ref={popupRef}>
            ...
            <div className="popup-buttons">
              <button onClick={() => speakText('deskParagraph')}>Listen To Audio</button>
              <button onClick={stopSpeech}>Stop Audio</button>
            </div>
            <div className="popup-button-close">
              <button className="close-button" onClick={() => {
